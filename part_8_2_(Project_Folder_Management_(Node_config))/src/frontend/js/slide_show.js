...
var postController = {
    renderPost: function (data) {
        ...
        //      create html tag : 
        if (data != undefined & Array.isArray(Object.entries(data.courseTags))) {
            //      create Tags : 
            var tags = this.renderTags(data.courseTags)
        } else {
            console.log("tag is not array" + data);
        }

        //      create HTML content
        var card_container = `
                <div class="img_container">
                <img class="post_img" src="https://s6.uupload.ir/files/آموزش-برنامه-نویسی_ih5b.jpg" alt="">
            </div>
